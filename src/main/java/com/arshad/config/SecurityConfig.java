...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http)
		...
		.antMatchers("/coupon/apply","/coupon/remove").hasAuthority(UserRole.BUYER.name())
//		.antMatchers("/user/register","/user/save").hasAuthority(UserRole.SELLER.name())
//		.antMatchers("/brand/**","/category/**","/categorytype/**").hasAuthority(UserRole.SELLER.name())
		.antMatchers("/product/**","/stock/**","/coupon/**","/shipping/**").hasAuthority(UserRole.SELLER.name())
		.antMatchers("/order/reports").hasAuthority(UserRole.SELLER.name())
